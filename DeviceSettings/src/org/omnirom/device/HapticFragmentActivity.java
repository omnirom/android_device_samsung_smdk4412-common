...
public class HapticFragmentActivity extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        VibratorTuningPreference mVibratorTuning = (VibratorTuningPreference) findPreference(KEY_VIBRATOR_TUNING);

        boolean hasVibratorTuning = res.getBoolean(R.bool.has_vibrator_tuning);
        boolean enableVibratorTuning = false;
        ...
        if (hasVibratorTuning) {
            ...
            if(VibratorTuningPreference.isSupported(vibratorFilePath)){
                  enableVibratorTuning = true;
            }
        }

        mVibratorTuning.setEnabled(enableVibratorTuning);
    }
